...
#kl = LineClient()
cl = LineClient(authToken="EAVLaOR1xsDYGQ5r95Ee.+r+jAIdxZWQoBO38ex8YVG.fXKbdvbcUA+Es+Mjo6fIm9pqMU0fievLl5u2viBTWAk=")
...
owner = ["u39f6835814970d554809a89e620f8281","ufd1fc96a20d7cf0a8e6e8dfc117f32be","uff4b10b2d156bd1192cbee0730355b1c","ua03f9ab918e138be621c993d833a6cc8","u4a6a20df7f349f6197c9b497da608516","u75c4b41b1338f7b913fbb8b640cce4af","ua86747152827236da6c00657897f8ae7","u9956cfb6461742deddad919a6270c79a"]
admin = ["u39f6835814970d554809a89e620f8281","ufd1fc96a20d7cf0a8e6e8dfc117f32be","uff4b10b2d156bd1192cbee0730355b1c","ua03f9ab918e138be621c993d833a6cc8","u4a6a20df7f349f6197c9b497da608516","u75c4b41b1338f7b913fbb8b640cce4af","ua86747152827236da6c00657897f8ae7","u9956cfb6461742deddad919a6270c79a"]
...
">>>Ⓑⓨⓔ_Ⓑⓨⓔ ⒼⒸ Ⓛⓐⓚⓝⓐⓣ>><\nⒹⓝⓓⓐⓜ Ⓒⓐⓡⓘ Ⓚⓜⓘ\n<<<<<<<<<>>\nhttp://line.me/ti/p/~reza.p.i.p\nhttp://line.me/ti/p/ryansakra_m1")
                        ...
                        elif cmd == "dk-botku" or cmd == "dkbotku":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
...
#===========BOT UPDATE============#
                        ...
                        elif cmd == "dk.respon" or cmd == "dk.absen":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                cl.sendMessage(msg.to, "[🔰 Ⓓⓚ~ⒷⓄⓣ☯t].")
                                ki.sendMessage(msg.to, "╚☆Ⓢⓘⓐⓟ☆╗\n╚Ⓚⓞⓜⓐⓝⓓⓝ╮╗")
