...
channel1 = LineChannel(kk,kk.server.CHANNEL_ID['LINE_TIMELINE'])
kk.log("Channel Access Token : " + str(channel1.channelAccessToken))

kc = LineClient(authToken="EAsCu0pmXEBM3C4QTd5b.x6JXUNwTo2ABeWsGFXEkYW.MuBtAiirsdOyOmVilQsq4hEieQuXS1cvs4bYST/TwIE=")
kc.log("Auth Token : " + str(kc.authToken))
channel1 = LineChannel(kc,kc.server.CHANNEL_ID['LINE_TIMELINE'])
kc.log("Channel Access Token : " + str(channel1.channelAccessToken))

kb = LineClient(authToken="EAnSVp5bMmJeEmJ12sXf.iXDW3NqeZe2QwsaB0p/2tW.PRbS7DgoNZYLWbxo+zkQ/cRcw+cYDsE44AgJhvO0pPM=")
kb.log("Auth Token : " + str(kb.authToken))
channel1 = LineChannel(kb,kb.server.CHANNEL_ID['LINE_TIMELINE'])
kb.log("Channel Access Token : " + str(channel1.channelAccessToken))

ke = LineClient(authToken="EAnSVp5bMmJeEmJ12sXf.iXDW3NqeZe2QwsaB0p/2tW.PRbS7DgoNZYLWbxo+zkQ/cRcw+cYDsE44AgJhvO0pPM=")
ke.log("Auth Token : " + str(ke.authToken))
channel1 = LineChannel(ke,ke.server.CHANNEL_ID['LINE_TIMELINE'])
ke.log("Channel Access Token : " + str(channel1.channelAccessToken))

sw = LineClient(authToken="EA3ldEcadjbvBBi8r987.ysELs5+0aaJPhSRVRuIgzW.aJaS/DruALMYUFAfR/R7taepEbxVm9pmQANtM+mdvZg=")
sw.log("Auth Token : " + str(sw.authToken))
channel1 = LineChannel(sw,sw.server.CHANNEL_ID['LINE_TIMELINE'])
                ...
                try:
                    if cl.getGroup(op.param1).preventedJoinByTicket == False:
                        if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                            ...
                            sw.sendMessage(op.param1,"wah kiker mainan qr minta di cipok")
                    ...
                    try:
                        ...
                        try:
                            ...
                            for _mid in gMembMids:
                                ...
                                ki.sendMessage(op.param1,"Antijs\nDK-BOT Hajar")
                        except:
                            try:
...
">>>Ⓑⓨⓔ_Ⓑⓨⓔ ⒼⒸ Ⓛⓐⓚⓝⓐⓣ>><\nⒹⓝⓓⓐⓜ Ⓒⓐⓡⓘ Ⓚⓜⓘ\n<<<<<<<<<>>\nhttp://line.me/ti/p/~reza.p.i.p\nhttp://line.me/ti/p/ryansakra_m1")
                        ...
                        elif cmd.startswith("bot6tcname: "):
                          if msg._from in admin:
                            separate = msg.text.split(" ")
                            string = msg.text.replace(separate[0] + " ","")
                            if len(string) <= 10000000000:
...
#===========COMMAND BLACKLIST============#
                            ...
                            if msg._from in admin:
                              if wait["blacklist"] == {}:
                                ...
                                for m_id in wait["blacklist"]:
                                    ...
                                    ma += str(a) + ". " +cl.getContact(m_id).displayName + "\n"
                                cl.sendMessage(msg.to,"✒ Dragon Blacklist User\n\n"+ma+"\nTotal「%s」Blacklist User" %(str(len(wait["blacklist"]))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              if wait["blacklist"] == {}:
                                    cl.sendMessage(msg.to,"Tidak ada blacklist")
                                    ka.sendMessage(msg.to,"Tidak ada blacklist")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              ...
                              ka.sendMessage(msg.to,"Sukses membersihkan " +mc)
