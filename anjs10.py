...
cl = LineClient("dzulkiflimusasawi2@gmail.com","")
...
KAC = [cl,ki,kk,kc,kb,kd,ke,kf,kg,sw]
ABC = [ki,kk,kc,kb,kd,ke,kf,kg,sw]
            ...
            if wait["autoAdd"] == True:
                if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                    if (wait["message"] in [" "," ","\n",None]):
                        ...
                        cl.sendContact(op.param1, "u345f290d38d6ab581ff25b01f49231e4")
...
#===========BOT UPDATE============#    
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"✒ Putra admin\n\nSuper admin:\n"+ma+"\nAdmin:\n"+mb+"\nStaff:\n"+mc+"\nTotal「%s」Putra staff" %(str(len(owner)+len(admin)+len(staff))))
                              ...
                              #    else:
                               for target in targets:
                                     if target not in Bots:
                                      try:
                                          klist=[ki,kk,kc,kb,kd,ke,kf,kg,sw]
                                          kicker=random.choice(klist)
                                          kicker.kickoutFromGroup(msg.to,[target])
                                          print (msg.to,[g.mid])
                                      except:
...
#===========ADMIN ADD============#
                        ...
                        elif cmd == "refresh" or text.lower() == '1':
                            if msg._from in admin:
                                wait["addadmin"] = False
                        ...
                        elif cmd == "botku" or text.lower() == 'contact bot':
                            if msg._from in admin:
                                ma = ""
                                for i in Bots:
                                    ma = cl.getContact(i)
...
#===========COMMAND BLACKLIST============#
                        ...
                        elif cmd == "talkbanlist" or text.lower() == '2':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                        ...
                        elif cmd == "clearban" or text.lower() == '4':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              wait["blacklist"] = {}
                            ...
                            if msg._from in admin:
                              if settings["autoJoinTicket"] == True:
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     group9 = sw.findGroupByTicket(ticket_id)
